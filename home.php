...
<div class="row">
  <div class="col-md-12 mb-5">
    <h2 class="sidebar-brand-text mx-3 text-center">Aplikasi Daftar Nilai Siswa</h2>
  </div>
  <div class="col-md-12 d-flex justify-content-center">
    <div class="card mb-3  w-75">
      <div class="card-body sidebar-brand-text mx-3 text-center">Form Input Nilai</div>
      <div class="card-body">
